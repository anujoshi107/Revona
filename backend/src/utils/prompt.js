...
4. Payment method must be one of: ${Object.values(PaymentMethodEnum).join(", ")}
5. If uncertain about any field, omit it
6. If not a receipt, return {}
...
- Use conversational language, correct wording, and avoid sounding robotic or generic
